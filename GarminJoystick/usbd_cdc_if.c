...
static int8_t GarminJoystick_Init     (void);
static int8_t GarminJoystick_DeInit   (void);
static int8_t GarminJoystick_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t GarminJoystick_Receive  (uint8_t* pbuf, uint32_t *Len);

USBD_CDC_ItfTypeDef USBD_CDC_GarminJoystick_fops = 
{
  GarminJoystick_Init,
  GarminJoystick_DeInit,
  GarminJoystick_Control,
  GarminJoystick_Receive
};
...
/**
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t GarminJoystick_Receive(uint8_t* Buf, uint32_t *Len)
{
