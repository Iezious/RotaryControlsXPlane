...
static int8_t GarminJoystick.F407_Init     (void);
static int8_t GarminJoystick.F407_DeInit   (void);
static int8_t GarminJoystick.F407_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t GarminJoystick.F407_Receive  (uint8_t* pbuf, uint32_t *Len);

USBD_CDC_ItfTypeDef USBD_CDC_GarminJoystick.F407_fops = 
{
  GarminJoystick.F407_Init,
  GarminJoystick.F407_DeInit,
  GarminJoystick.F407_Control,
  GarminJoystick.F407_Receive
};
...
/**
  * @brief  GarminJoystick.F407_Init
...
/**
  * @brief  GarminJoystick.F407_DeInit
...
/**
  * @brief  GarminJoystick.F407_Control
...
/**
  * @brief  GarminJoystick.F407_Receive
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t GarminJoystick.F407_Receive(uint8_t* Buf, uint32_t *Len)
{
